        ...
        <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
            <div class="space-y-12">
                <div class="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
                    <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">Admin Section</h2>
                    <p class="text-xl text-gray-500">On the Admin Section you can customice your app.</p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-indigo-500 text-white p-4 rounded-lg">
                        <h3 class="text-2xl font-bold">Total Courses</h3>
                        <p class="text-xl">{{ $totalCourses }}</p>
                    </div>
                    <div class="bg-indigo-500 text-white p-4 rounded-lg">
                        <h3 class="text-2xl font-bold">Total Videos</h3>
                        <p class="text-xl">{{ $totalVideos }}</p>
                    </div>
                    <div class="bg-indigo-500 text-white p-4 rounded-lg">
